    ...
    stages {
        ...
        stage('Docker Tag the Image') {
            steps {
                ...
                sh 'sudo docker tag snapchat-sak-cicd-docker Sai-pragath/snapchat-sak-cicd-docker:latest'
            }
            post {
                success {
        ...
        stage('Docker Push the Image') {
            steps {
                ...
                sh 'sudo docker push Sai-pragath/snapchat-sak-cicd-docker:latest'
            }
            post {
                success {
        ...
        stage('Cleanup Local Docker Images') {
            steps {
                ...
                sh '''
                    sudo docker rmi Sai-pragath/snapchat-sak-cicd-docker:latest
                    ...
                    if (containerExists) {
                        ...
                        if (userChoice == 'Yes') {
                            ...
                            sh '''
                                ...
                                sudo docker run -d -p 8084:8080 --name snapchat-container Sai-pragath/snapchat-sak-cicd-docker:latest
                            '''
                        } else {
                        ...
                        sh 'sudo docker run -d -p 8084:8080 --name snapchat-container Sai-pragath/snapchat-sak-cicd-docker:latest'
                    }
                }
            }
        }
